...
print(f"DLA (numba): N={N}, n_steps={N_STEPS}, eta={ETA}, omega={OMEGA:.4f}")
...
fig.suptitle(f"PDE-based DLA on a {N}$\\times${N} grid (numba SOR)", fontsize=14)
plt.tight_layout()

filename = "a2_1_dla_by_sor_numba.png"
